...
const PRIVACY_TEXT = {
  ko: {
    ...
    collectList: [
      "가사 동기화를 위한 Spotify 계정 정보 (OAuth)",
  ...
  en: {
    ...
    collectList: [
      "Spotify Account Information (via OAuth) to sync lyrics.",
    ...
    useList: [
      ...
      "Sync lyrics with your current Spotify playback.",
